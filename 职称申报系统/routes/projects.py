...
_TAB_MATERIALS = [
    ...
    },
    {
        ...
        "folder": "08-1_业绩成果",
        "items": [
            {"name": "业绩成果佐证材料",          "fill": "file", "required_for": [],
             "note": "项目合同、验收报告等扫描件"},
            {"name": "符合评审条件项",            "fill": "auto", "required_for": [], "note": ""},
            {"name": "是否代表性成果",            "fill": "auto", "required_for": [], "note": ""},
            {"name": "开始时间",                  "fill": "auto", "required_for": [], "note": ""},
            {"name": "截止时间",                  "fill": "auto", "required_for": [], "note": ""},
            {"name": "业绩成果",                  "fill": "auto", "required_for": [], "note": ""},
            {"name": "项目级别",                  "fill": "auto", "required_for": [], "note": ""},
            {"name": "个人排名",                  "fill": "auto", "required_for": [], "note": ""},
        ],
    },
    {
        "tab": "8-2",
        ...
        "folder": "08-2_获奖情况",
        "items": [
            {"name": "获奖证书扫描件",            "fill": "file", "required_for": [],
             "desc": ""},
            {"name": "授奖时间",                  "fill": "auto", "required_for": [],
             "desc": ""},
            {"name": "名称与内容提要",            "fill": "auto", "required_for": [],
             "desc": ""},
            {"name": "奖励等级",                  "fill": "auto", "required_for": [],
             "desc": "省部级/市厅级等"},
            {"name": "授奖机关",                  "fill": "auto", "required_for": [],
             "desc": ""},
            {"name": "个人排名",                  "fill": "auto", "required_for": [],
             "desc": ""},
        ],
    },
    {
        ...
        "folder": "09_学术成果",
        "items": [
            {"name": "学术成果扫描件",            "fill": "file", "required_for": [],
             "note": "论文、著作等扫描件"},
            {"name": "符合评审条件项",            "fill": "auto", "required_for": [], "desc": ""},
            {"name": "是否代表性成果",            "fill": "auto", "required_for": [], "desc": ""},
            {"name": "发表时间",                  "fill": "auto", "required_for": [], "desc": ""},
            {"name": "学术成果类别",              "fill": "auto", "required_for": [], "desc": ""},
            {"name": "学术成果名称",              "fill": "auto", "required_for": [], "desc": ""},
            {"name": "登载刊物名称",              "fill": "auto", "required_for": [], "desc": ""},
            {"name": "角色",                      "fill": "auto", "required_for": [], "desc": ""},
            {"name": "是否代表作",                "fill": "auto", "required_for": [], "desc": ""},
        ],
    },
    {
        "tab": "10",
